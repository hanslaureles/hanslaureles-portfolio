...
(function () {
  ...
  const KNOWLEDGE_BASE = [
    ...
    },
    {
      ...
      keywords: ["ciel", "manas", "voice", "hud", "thought acceleration", "groq", "whisper", "tensura", "divine wisdom", "elevenlabs", "obsidian", "mcp", "speech", "copilot", "audio", "dsp", "latency", "real-time", "universal knowledge", "reasoning"],
      summary: "Hans architected Manas: Ciel, an autonomous voice-first cognitive copilot operating with a Dual-Mode Cognitive Architecture: universal knowledge synthesis across computer science and general AI, paired with sub-800ms speech-to-speech local swarm orchestration.",
      evidence: "Features real-time speech loop with local PyAudio streaming, Thought Acceleration DSP (+5Hz pitch, 1.25x tempo), direct universal cognitive reasoning, bidirectional tool invocation into Obsidian AI Brain via MCP, dual-monitor visual state telemetry, and proactive 4-domain background sentinels.",
